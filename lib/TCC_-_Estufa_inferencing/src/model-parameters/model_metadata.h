...
#define EI_CLASSIFIER_PROJECT_ID                 764835
#define EI_CLASSIFIER_PROJECT_OWNER              "Turjillio"
#define EI_CLASSIFIER_PROJECT_NAME               "TCC - Estufa"
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "Umidade do Solo (%) + Umidade do Ar (%) + Temperatura do Ar (°C) + CO2 (PPM)"
